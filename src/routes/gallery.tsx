...
const SHOTS = [
  ...
  { label: "Bread production line", h: "aspect-[16/10]" },
  { label: "Oven / baking area", h: "aspect-[4/3]" },
  { label: "Cooling conveyor", h: "aspect-[4/3]" },
  { label: "Packaging area", h: "aspect-[4/5]" },
  { label: "Rusk / biscuit line", h: "aspect-[4/3]" },
  { label: "Finished product — shelf shot", h: "aspect-[4/3]" },
